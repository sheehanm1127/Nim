...
var count = 0;
// declare variable turn and set equal to 0
var turn = 0;
...
while (again == true) {
	...
	// variable count set equal to 0
	count = 0;
	// variable turn set equal to 0
	turn = 0;
	// variable turns set equal to 0
	turns = 0;
	// variable next set equal to the remainder of games divided by 2
	next = games % 2;
